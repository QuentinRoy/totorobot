...
([rationale §5](docs/api-rationale.md#data-is-a-convention-not-a-rule)).
...
from `send` ([rationale §6](docs/api-rationale.md#what-it-forces-open)).
...
([rationale §12](docs/api-rationale.md#12-sending-inputs)).
...
[rationale §11](docs/api-rationale.md#residency-is-derivable-not-a-host-feature),
...
included, is [rationale §11](docs/api-rationale.md#queue-not-stack).
...
| `keep` / `repeat` / `stay`  | an ordinary self-transition row ([§7](docs/api-rationale.md#7-self-transitions))                                      |
| `else`                      | declining is a normal outcome, and silent ([§4](docs/api-rationale.md#two-decisions-that-fell-out-of-the-comparison)) |
| a `send` return value       | `current` ([§11](docs/api-rationale.md#send-returns-nothing))                                                         |
| `stop()`                    | unsubscribe, and stop sending ([§11](docs/api-rationale.md#no-disposal-and-a-listener-that-throws))                   |
| typed `send`                | nothing at runtime either; recorded but unbuilt ([§12](docs/api-rationale.md#if-it-comes-back-it-comes-back-as-s12))  |

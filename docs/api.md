...
24. `observe` returns an unsubscribe function; calling it more than once is harmless.
25. A malformed `observe()` pattern throws the same `SyntaxError`, at registration,
